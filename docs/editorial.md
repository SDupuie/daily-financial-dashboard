...
3. Review downloaded News after prices and before making any editorial decisions.
   ...
   - Treat every candidate in the generated News inventory as eligible for metadata triage. Rank only deeply reviewed contenders. Use the News-card selection counts as targets; when fewer strong candidates are available, select the strongest available cards and do not invent filler.
