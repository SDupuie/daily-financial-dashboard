...
- **AI Editorial Work:** writes only to `generated/editorial/dashboard-data.json` and the review checkpoint defined in the [News inventory contract](docs/editorial.md#news-inventory-contract); refreshed quotes need reviewed commentary, while failed quote downloads retain their prior validated quote and commentary together.
